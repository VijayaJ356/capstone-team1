...
public class TransactionInfo {
	...
	public TransactionInfo(Integer transactionId, String transactionDate, String transactionTime,
	   ...
	   private Integer generateTransactionId() {
	        ...
	        return (int) (timestamp * 10000 + randomSuffix);         // Combine timestamp and random number
	    }
